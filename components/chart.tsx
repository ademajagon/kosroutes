...
function ChartInner({ data, height, width }: ChartInnerProps): JSX.Element {
  ...
  const handleMouseMove = (e) => {
    ...
    const posX = e.clientX
      ? e.clientX
      : clamp(e.targetTouches[0].clientX, 58, width + 32); // TODO: measure - 58px from left screen edge, 32px from right
